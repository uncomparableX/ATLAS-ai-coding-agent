...
const features = [
  {
    ...
    description: "Deploy AI agents that plan, code, debug, test, and execute complex engineering workflows autonomously.",
  },
  {
    icon: GitBranch,
    title: "GitHub Native",
    description: "Connect repositories, create branches, generate pull requests, and automate reviews directly.",
  },
  {
    icon: Zap,
    title: "Real-Time Execution",
    description: "Watch tasks execute live with logs, streamed reasoning, status updates, and live progress tracking.",
  },
  {
    icon: Shield,
    title: "Sandboxed & Secure",
    description: "Every execution runs inside isolated secure environments with resource and access controls.",
  },
  {
    icon: Workflow,
    title: "Multi-Agent Orchestration",
    description: "Planner, coder, reviewer, and executor agents work together in coordinated workflows.",
  },
  {
    icon: Terminal,
    title: "Developer-First UX",
    description: "Built for engineers with logs, terminals, dashboards, observability, and deployment workflows.",
  },
];
    ...
    <main className="relative min-h-screen bg-background overflow-hidden">
      ...
      <section id="architecture" className="py-24 px-6 relative">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground">Specialized AI agents working together</p>
          </div>

          <GlassCard className="p-8">
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { title: "Planner", desc: "Breaks down tasks and creates execution plans" },
                { title: "Builder", desc: "Writes, edits, and executes engineering workflows" },
                { title: "Reviewer", desc: "Tests, validates, and ensures production quality" },
              ].map((agent) => (
                <div key={agent.title} className="p-6 rounded-xl border border-white/10 bg-white/5">
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <GlassCard className="p-12" glow>
            <h2 className="text-4xl font-bold mb-4">Ready to build with ATLAS?</h2>
      ...
      <footer className="border-t border-white/5 py-12 px-6">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <p className="text-sm text-muted-foreground">© 2026 ATLAS. All rights reserved.</p>
        </div>
      </footer>
    </main>
  );
